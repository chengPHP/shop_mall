...
<div class="ibox-content">
    <form method="post" class="form-horizontal" action="{{url('admin/color')}}/{{$info->id}}">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select id="pid" class="form-control m-b select2" name="pid">
                        {!! color_select($info->pid,1,$info->id) !!}
                    </select>
                </div>
            </div>
            <div class="hr-line-dashed"></div>
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-danger" onclick="deleteColor('{{$info->id}}')">删除</button>
