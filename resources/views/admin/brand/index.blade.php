...
@section('content')
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-title">
                        ...
                        <button onclick="delBrands()" class="btn btn-m btn-danger" id="add-btn"><i class="fa fa-trash-o"></i> 删除</button>
                        <div class="col-sm-5" style="float: right;" >
                            <div class="input-group">
                                <input type="text" id="search-text" placeholder="品牌名称" value="{{$search}}" class="form-control">
                            ...
                            <tbody>
                                @foreach($list as $v)
                                    <tr>
                                        ...
                                        <td>{{$v['brand_desc']}}</td>
                                        <td>
                                            <span class="btn btn-xs btn-info" title="修改信息" onclick="updateBrand('{{$v['id']}}')" data-toggle="modal" data-target=".bs-example-modal-md"><i class="fa fa-wrench"></i> 修改</span>

                                            <span class="btn btn-xs btn-danger" title="删除品牌" onclick="deleteBrand('{{$v['id']}}')"><i class="fa fa-trash-o" ></i> 删除</span>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
    ...
    <script type="text/javascript" >
        ...
        function deleteBrand(id) {
            deleteItems(id,"{{url('admin/brand')}}","确定删除该品牌吗？");
        }
        ...
        function delBrands() {
            ...
            if(checkStatus.length >= 1){
                ...
                ids = ids.toString();
                deleteItems(ids,"{{url('admin/brand')}}","确定删除这些品牌吗？");
        ...
        $("#simple-search").on('click',function () {
            window.location.href = "{{url('admin/brand')}}?search="+$("#search-text").val();
        });
