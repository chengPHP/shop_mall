            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" action="{{url('admin/work')}}" enctype="multipart/form-data">
                            <div class="modal-body">
                                {{csrf_field()}}
                                <div class="form-group">
                                    <label for="editor" class="col-sm-2 control-label">工作名称</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="contents" placeholder="工作名称" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <script id="work_details" type="text/plain" style="width:100%;height:200px;"></script>
                                ...
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    <label for="descr" class="col-sm-2 control-label">工作计划开始时间</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="jeinput form-control" id="plan_start_time" name="plan_start_time" placeholder="YYYY-MM-DD hh:mm:ss">
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    <label for="descr" class="col-sm-2 control-label">工作计划完成时间</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="jeinput form-control" id="plan_end_time" name="plan_end_time" placeholder="YYYY-MM-DD hh:mm:ss">
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                            </div>
