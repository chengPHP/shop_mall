...
<li class="{{ active_class(if_uri_pattern('admin/good*') || if_uri_pattern('admin/category*') || if_uri_pattern('admin/brand*') || if_uri_pattern('admin/color*')) }}">
    <a href="{{url('admin/')}}"><i class="fa fa-folder-open"></i> <span class="nav-label">商品管理</span> <span
...
<li class="{{ active_class(if_uri_pattern('admin/member*') || if_uri_pattern('admin/rank*') || if_uri_pattern('admin/region*')) }}">
    <a href="{{url('admin/')}}"><i class="fa fa-folder-open"></i> <span class="nav-label">会员管理</span> <span
                class="fa arrow"></span></a>
    <ul class="nav nav-second-level">
